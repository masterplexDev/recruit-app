...
%> --%>
				...
				<form id="frmWrite" name="frmWrite"
					action="notice_write_process.jsp" method="post">
		...
		<option value="2">공지사항</option>
	  </select> --> <input id="title" name="title" class="inputTypeText"
										placeholder="" maxLength="125" value="" type="text" />
									</td>
								</tr>
							</tbody>
						</table>
				...
				<div class="ec-base-button ">
					<span class="gLeft"> <input type="button" value="목록"
						class="btnNormalFix sizeS" id="btnList" name="btnList"
						onclick="location.href='http://localhost/recruit-app/manage/notice/notices.jsp'" />
					</span> <span class="gRight"> <input type="button" value="등록"
						class="btnSubmitFix sizeS" id="btnWrite" name="btnWrite"
						onclick="location.href='http://localhost/recruit-app/manage/notice/notices.jsp'" />
						<input type="button" value="취소" class="btnBasicFix sizeS"
