<%@ page language="java" contentType="text/html; charset=UTF-8"
  ...
  <div class="header">
    ...
    <div class="term" style="display: none">
      <span id="spn_Career_Term_Year">0</span> 년
      <span id="spn_Career_Term_Month">0</span> 개월
    </div>
      ...
      <div class="container container1">
        <div class="row">
          ...
          <div class="input input-career-name is-label" data-comp_type="jkAc">
            <label for="Career_C_Name_c14"
              >회사명 <span class="star">*</span></label
            >
            <input
              type="text"
              id="Career_C_Name_c14"
          ...
          <div class="input input-career-part is-label">
            ...
            <input
              type="text"
              name="Career[c14].C_Part"
              id="Career_C_Part_c14"
              value=""
              maxlength="25"
            />
          </div>
          <div class="input input-career-joindate is-label">
            <label for="Career_CSYM_c14"
              >입사년월 <span class="star">*</span></label
            >
            <input
              type="text"
              name="Career[c14].CSYM"
              id="Career_CSYM_c14"
              value=""
          ...
          <div class="input input-career-leavedate is-label">
            <label for="Career_CEYM_c14"
              >퇴사년월 <span class="star">*</span></label
            >
            <input
              type="text"
              name="Career[c14].CEYM"
              id="Career_CEYM_c14"
              value=""
              data-format-type="month"
              class="devCareerCEYM"
        ...
        <div class="row">
          ...
          <div class="input input-career-salary is-label salaryInput">
            ...
            <input
              type="text"
              name="Career[c14].M_MainPay_User"
              id="Career_M_MainPay_User_c14"
              value=""
              data-format-type="price"
              maxlength="7"
        ...
        <div class="row workInputRow">
          <div class="textarea is-label workInput">
            ...
            <textarea
              name="Career[c14].Prfm_Prt"
              cols="30"
              rows="2"
              id="Career_Prfm_Prt_c14"
              class="textarea-career"
...
<script type="text/template" id="tplCareerItem"></script>
