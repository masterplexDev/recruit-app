	...
	<div class="form formLanguage">
		<div id="language_containers">
			<div class="container container1">
				<input type="hidden" name="Language.Index" value="c508" /> <input
					type="hidden" name="Language[c508].Index_Name" value="c508" />
				...
				<div class="row">
					<div class="dropdown dropdown-category is-label">
						...
						<input type="hidden" id="Language_Eval_Category_c508" value=""
							name="Language[c508].Eval_Category" />
					</div>
					...
					<div
						...
						<input type="hidden" name="Language[c508].Lang1_Name" value=""
							id="Language_Lang1_Name_c508" />
					</div>

					<div class="input input-language-name is-label devLanguageInput"
						style="display: none">
						<label for="Language_Lang_Etc_c508">외국어명
							<span class="star">*</span>
						</label> <input type="text" name="Language[c508].Lang_Etc"
							id="Language_Lang_Etc_c508" maxlength="25" value="" />
						<input type="hidden" name="Language[c508].Lang1_Name" value=""
							id="Language_Lang1_Name_c508" />
					</div>
					...
					<span class="devExamArea" style="display: none">
						...
						<div class="input input-language is-label devExamInput">
							<label for="Language_Test_Etc_c508">공인시험
								<span class="star">*</span>
						...
						<div class="input input-grade is-label devExamGradeInput">
							<label for="Language_Test1_Point_I_c508">급수/점수
								<span class="star">*</span>
						...
						<div
							...
							<input type="hidden" name="Language[c508].Point_Grade_Type_Code"
