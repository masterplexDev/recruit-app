  ...
  <div id="__next" data-reactroot="">
    ...
    <div class="slick-slide" tabindex="-1" aria-hidden="false" style="outline: none; width: calc(25% - 10px); margin-right: 10px;">
        <a href="../recruit/detail.jsp">
            ...
            <div>
                 <p style="margin-bottom: 4px; overflow: hidden; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; text-overflow: ellipsis; font-weight: 600; font-size: 16px; letter-spacing: .0057em; line-height: 24px;">
                 ${post.title}</p>
